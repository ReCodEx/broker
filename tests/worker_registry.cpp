...
TEST(worker_registry, basic_lookup)
{
	...
	auto worker1 = worker_registry::worker_ptr(new worker(
		"id1234",
		{
			{"env", "python"},
			{"env", "c"},
	...
	auto worker2 = worker_registry::worker_ptr(new worker(
		"id12345",
		{
			{"env", "c"},
			{"hwgroup", "group_2"}
	...
	worker_registry::headers_t headers1 = {
		{"env", "python"}
	};

	worker_registry::headers_t headers2 = {
		{"hwgroup", "group_2"}
	};

	worker_registry::headers_t headers3 = {
		{"env", "python"},
		{"hwgroup", "group_2"}
	};
