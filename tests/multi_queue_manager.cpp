...
TEST(multi_queue_manager, add_worker)
{
...
TEST(multi_queue_manager, basic_queueing)
{
	std::multimap<std::string, std::string> headers = {};
	job_request_data data("", {});
...
TEST(multi_queue_manager, terminate_basic)
{
	multi_queue_manager manager;
...
TEST(multi_queue_manager, terminate_no_current)
{
	multi_queue_manager manager;
...
TEST(multi_queue_manager, terminate_empty)
{
	multi_queue_manager manager;
...
TEST(multi_queue_manager, load_balancing)
{
	multi_queue_manager manager;
